                        ...
                        <h2 class="bdac-news-title bdac-bg-white p-3 p-md-5">Recent News</h2>';
                            ...
                            while( $bdac_news->have_posts() ) {
                                ...
                                <div class="bdac-news-article bdac-bg-blue p-3 p-md-5">
                                 ...
                                 <div class="col col-12 col-md-8 p-0" style="border-radius: 0.625rem 0.625rem 0.625rem 0; overflow: hidden;">
                                     <img src="' . $news_thumb . '" class="w-100 h-100" style="object-fit: cover;">
                                </div>
                                ';
                            }

                            // $bdac_news = new WP_Query( 
                            //     // array(
                            //     //     'posts_per_page' => 1,
                            //     //     'post_type' => 'post'
                            //     // ) 
