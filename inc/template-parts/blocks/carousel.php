...
<section class="<?php echo esc_attr( $className ); ?> p-0">
    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-bs-ride="false">
        ...
        <?php
            ...
            $carouselArrow = '
                <a class="carousel-control-%1$s" href="#mainCarousel" role="button" data-slide="%1$s">
                ...
                while ( have_rows( 'carousel' ) ) : the_row();
                    ...
                    echo '
                        <div class="carousel-item ' . ( $slide === 0 ? 'active' : '' ) . '" data-interval="' . ( $carouselInterval ? $carouselInterval : 8500 ) . '">
                            <img class="carousel-item-image" src="' . ( $carouselImg ? $carouselImg['url'] : 'no image' ) . '" class="d-block w-100" alt="...">
                            <div class="carousel-inner-overlay"></div>
                            <div class="container h-100">
                                <div class="row h-100">
                                    <div class="col col-12 col-md-5">
                                        <div class="carousel-caption d-md-block">
                                            <h1 class="carousel-caption-title">' . ( $carouselTitle ? $carouselTitle : '!Interested in visiting our collection?' ) . '</h1>
                                            <a href="' . $carouselLink['url'] . '" class="carousel-caption-button">
                                                <button>' . $carouselLink['title'] . '</button>
                                            </a>
                                        </div>
                                    </div>
                                </div>
