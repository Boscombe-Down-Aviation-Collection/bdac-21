...
<footer id="footer">
    ...
    <div class="container">
        ...
        <div class="row d-flex flex-row justify-content-center align-items-center">
            ...
            <a href="https://aviationheritageuk.org/" target="_blank">
            ...
            <a href="https://www.visitbritain.org/business-advice/were-good-go-industry-standard" target="_blank">
                <img src="<?php bloginfo('template_url'); ?>/inc/img/gtg-mark_England.png" alt="We're Good To Go Logo" class="footer-associate">
            </a>
        </div>
    </div>
    </footer>
